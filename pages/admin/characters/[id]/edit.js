...
import { EditPage } from '../../../../components/Admin/CommonCrud';
import { useSingleDataFetching, useMasterDataFetching } from '../../../../hooks/useDataFetching';
...
export default function EditCharacter() {
    ...
    // キャラクターデータを取得
    const { data: characterData, loading: characterLoading } = useSingleDataFetching(
        'mst_roles',
        id,
        {
            select: `
    ...
    const dataLoading = authLoading || mastersLoading || characterLoading;
